...
export function Header({ title, description }: HeaderProps) {
  ...
  return (
    <div className="flex items-center justify-between border-b border-white/10 bg-gradient-to-r from-black/50 to-black/30 backdrop-blur-sm px-2 sm:px-3 md:px-4 lg:px-6 py-3 sm:py-4 md:py-5 safe-top">
        ...
        {user && (
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button variant="ghost" size="sm" className="text-white hover:bg-white/10 touch-target p-1 sm:p-2">
